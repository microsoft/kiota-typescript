 ...
 */
export function deserialize<T extends Parsable>(
  contentType: string,
...
function getParseNode(
  ...
  return ParseNodeFactoryRegistry.defaultInstance.getRootParseNode(
    contentType,
    buffer,
  );
}
 ...
 */
export function deserializeCollection<T extends Parsable>(
  contentType: string,
  bufferOrString: ArrayBuffer | string,
  factory: ParsableFactory<T>,
): T[] | undefined {
