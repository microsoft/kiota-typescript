 ...
 */
export const enableBackingStoreForSerializationWriterFactory = (serializationWriterFactoryRegistry: SerializationWriterFactoryRegistry, parseNodeFactoryRegistry: ParseNodeFactoryRegistry, original: SerializationWriterFactory): SerializationWriterFactory => {
 ...
 */
export const enableBackingStoreForParseNodeFactory = (parseNodeFactoryRegistry: ParseNodeFactoryRegistry, original: ParseNodeFactory): ParseNodeFactory => {
	if (!original) throw new Error("Original must be specified");
	let result = original;
 ...
 */
const enableBackingStoreForParseNodeRegistry = (registry: ParseNodeFactoryRegistry): void => {
 ...
 */
const enableBackingStoreForSerializationRegistry = (registry: SerializationWriterFactoryRegistry): void => {
	for (const [k, v] of registry.contentTypeAssociatedFactories) {
