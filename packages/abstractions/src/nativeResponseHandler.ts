...
export class NativeResponseHandler implements ResponseHandler {
	...
	public handleResponse<NativeResponseType, ModelType>(response: NativeResponseType, errorMappings: ErrorMappings | undefined): Promise<ModelType | undefined> {
		this.value = response;
		this.errorMappings = errorMappings;
		return Promise.resolve<ModelType | undefined>(undefined);
	}
}
