...
describe("kiotaSerializer", () => {
  it("defends serialize", () => {
    assert.throws(() =>
      serialize(
        "",
        undefined as unknown as Parsable,
        undefined as unknown as ModelSerializerFunction<TestBackedModel>,
      ),
    );
    assert.throws(() =>
      serialize(
  ...
  it("defends deserialize", () => {
    assert.throws(() =>
      deserialize(
        "",
        "",
        undefined as unknown as ParsableFactory<TestBackedModel>,
      ),
    );
    assert.throws(() =>
      deserialize(
  ...
  it("Serializes a collection", () => {
    ...
    const result = serializeCollectionToJsonAsString(
      [testEntity],
      serializeTestBackModel,
    );
