...
export function deserializeIntoAttachment(attachment: Partial<Attachment> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		contentType: (n) => {
			attachment.contentType = n.getStringValue();
		},
		isInline: (n) => {
			attachment.isInline = n.getBooleanValue();
		},
		lastModifiedDateTime: (n) => {
			attachment.lastModifiedDateTime = n.getDateValue();
		},
		name: (n) => {
			attachment.name = n.getStringValue();
		},
		size: (n) => {
			attachment.size = n.getNumberValue();
		},
	};
}
/**
...
export function deserializeIntoAttachmentCollectionResponse(attachmentCollectionResponse: Partial<AttachmentCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			attachmentCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			attachmentCollectionResponse.value = n.getCollectionOfObjectValues<Attachment>(createAttachmentFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoDateTimeTimeZone(dateTimeTimeZone: Partial<DateTimeTimeZone> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		dateTime: (n) => {
			dateTimeTimeZone.dateTime = n.getStringValue();
		},
		timeZone: (n) => {
			dateTimeTimeZone.timeZone = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoEmailAddress(emailAddress: Partial<EmailAddress> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		address: (n) => {
			emailAddress.address = n.getStringValue();
		},
		name: (n) => {
			emailAddress.name = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoExtensionCollectionResponse(extensionCollectionResponse: Partial<ExtensionCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			extensionCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			extensionCollectionResponse.value = n.getCollectionOfObjectValues<Extension>(createExtensionFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoFollowupFlag(followupFlag: Partial<FollowupFlag> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		completedDateTime: (n) => {
			followupFlag.completedDateTime = n.getObjectValue<DateTimeTimeZone>(createDateTimeTimeZoneFromDiscriminatorValue);
		},
		dueDateTime: (n) => {
			followupFlag.dueDateTime = n.getObjectValue<DateTimeTimeZone>(createDateTimeTimeZoneFromDiscriminatorValue);
		},
		flagStatus: (n) => {
			followupFlag.flagStatus = n.getEnumValue<FollowupFlagStatus>(FollowupFlagStatusObject);
		},
		startDateTime: (n) => {
			followupFlag.startDateTime = n.getObjectValue<DateTimeTimeZone>(createDateTimeTimeZoneFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoInferenceClassification(inferenceClassification: Partial<InferenceClassification> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		overrides: (n) => {
			inferenceClassification.overrides = n.getCollectionOfObjectValues<InferenceClassificationOverride>(createInferenceClassificationOverrideFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoInferenceClassificationOverride(inferenceClassificationOverride: Partial<InferenceClassificationOverride> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		classifyAs: (n) => {
			inferenceClassificationOverride.classifyAs = n.getEnumValue<InferenceClassificationType>(InferenceClassificationTypeObject);
		},
		senderEmailAddress: (n) => {
			inferenceClassificationOverride.senderEmailAddress = n.getObjectValue<EmailAddress>(createEmailAddressFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoInferenceClassificationOverrideCollectionResponse(inferenceClassificationOverrideCollectionResponse: Partial<InferenceClassificationOverrideCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			inferenceClassificationOverrideCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			inferenceClassificationOverrideCollectionResponse.value = n.getCollectionOfObjectValues<InferenceClassificationOverride>(createInferenceClassificationOverrideFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoInternetMessageHeader(internetMessageHeader: Partial<InternetMessageHeader> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		name: (n) => {
			internetMessageHeader.name = n.getStringValue();
		},
		value: (n) => {
			internetMessageHeader.value = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoItemBody(itemBody: Partial<ItemBody> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		content: (n) => {
			itemBody.content = n.getStringValue();
		},
		contentType: (n) => {
			itemBody.contentType = n.getEnumValue<BodyType>(BodyTypeObject);
		},
	};
}
/**
...
export function deserializeIntoMailFolder(mailFolder: Partial<MailFolder> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		childFolderCount: (n) => {
			mailFolder.childFolderCount = n.getNumberValue();
		},
		childFolders: (n) => {
			mailFolder.childFolders = n.getCollectionOfObjectValues<MailFolder>(createMailFolderFromDiscriminatorValue);
		},
		displayName: (n) => {
			mailFolder.displayName = n.getStringValue();
		},
		isHidden: (n) => {
			mailFolder.isHidden = n.getBooleanValue();
		},
		messageRules: (n) => {
			mailFolder.messageRules = n.getCollectionOfObjectValues<MessageRule>(createMessageRuleFromDiscriminatorValue);
		},
		messages: (n) => {
			mailFolder.messages = n.getCollectionOfObjectValues<Message>(createMessageFromDiscriminatorValue);
		},
		multiValueExtendedProperties: (n) => {
			mailFolder.multiValueExtendedProperties = n.getCollectionOfObjectValues<MultiValueLegacyExtendedProperty>(createMultiValueLegacyExtendedPropertyFromDiscriminatorValue);
		},
		parentFolderId: (n) => {
			mailFolder.parentFolderId = n.getStringValue();
		},
		singleValueExtendedProperties: (n) => {
			mailFolder.singleValueExtendedProperties = n.getCollectionOfObjectValues<SingleValueLegacyExtendedProperty>(createSingleValueLegacyExtendedPropertyFromDiscriminatorValue);
		},
		totalItemCount: (n) => {
			mailFolder.totalItemCount = n.getNumberValue();
		},
		unreadItemCount: (n) => {
			mailFolder.unreadItemCount = n.getNumberValue();
		},
	};
}
/**
...
export function deserializeIntoMailFolderCollectionResponse(mailFolderCollectionResponse: Partial<MailFolderCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			mailFolderCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			mailFolderCollectionResponse.value = n.getCollectionOfObjectValues<MailFolder>(createMailFolderFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoMessage(message: Partial<Message> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		attachments: (n) => {
			message.attachments = n.getCollectionOfObjectValues<Attachment>(createAttachmentFromDiscriminatorValue);
		},
		bccRecipients: (n) => {
			message.bccRecipients = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		body: (n) => {
			message.body = n.getObjectValue<ItemBody>(createItemBodyFromDiscriminatorValue);
		},
		bodyPreview: (n) => {
			message.bodyPreview = n.getStringValue();
		},
		ccRecipients: (n) => {
			message.ccRecipients = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		conversationId: (n) => {
			message.conversationId = n.getStringValue();
		},
		conversationIndex: (n) => {
			message.conversationIndex = n.getStringValue();
		},
		extensions: (n) => {
			message.extensions = n.getCollectionOfObjectValues<Extension>(createExtensionFromDiscriminatorValue);
		},
		flag: (n) => {
			message.flag = n.getObjectValue<FollowupFlag>(createFollowupFlagFromDiscriminatorValue);
		},
		from: (n) => {
			message.from = n.getObjectValue<Recipient>(createRecipientFromDiscriminatorValue);
		},
		hasAttachments: (n) => {
			message.hasAttachments = n.getBooleanValue();
		},
		importance: (n) => {
			message.importance = n.getEnumValue<Importance>(ImportanceObject);
		},
		inferenceClassification: (n) => {
			message.inferenceClassification = n.getEnumValue<InferenceClassificationType>(InferenceClassificationTypeObject);
		},
		internetMessageHeaders: (n) => {
			message.internetMessageHeaders = n.getCollectionOfObjectValues<InternetMessageHeader>(createInternetMessageHeaderFromDiscriminatorValue);
		},
		internetMessageId: (n) => {
			message.internetMessageId = n.getStringValue();
		},
		isDeliveryReceiptRequested: (n) => {
			message.isDeliveryReceiptRequested = n.getBooleanValue();
		},
		isDraft: (n) => {
			message.isDraft = n.getBooleanValue();
		},
		isRead: (n) => {
			message.isRead = n.getBooleanValue();
		},
		isReadReceiptRequested: (n) => {
			message.isReadReceiptRequested = n.getBooleanValue();
		},
		multiValueExtendedProperties: (n) => {
			message.multiValueExtendedProperties = n.getCollectionOfObjectValues<MultiValueLegacyExtendedProperty>(createMultiValueLegacyExtendedPropertyFromDiscriminatorValue);
		},
		parentFolderId: (n) => {
			message.parentFolderId = n.getStringValue();
		},
		receivedDateTime: (n) => {
			message.receivedDateTime = n.getDateValue();
		},
		replyTo: (n) => {
			message.replyTo = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		sender: (n) => {
			message.sender = n.getObjectValue<Recipient>(createRecipientFromDiscriminatorValue);
		},
		sentDateTime: (n) => {
			message.sentDateTime = n.getDateValue();
		},
		singleValueExtendedProperties: (n) => {
			message.singleValueExtendedProperties = n.getCollectionOfObjectValues<SingleValueLegacyExtendedProperty>(createSingleValueLegacyExtendedPropertyFromDiscriminatorValue);
		},
		subject: (n) => {
			message.subject = n.getStringValue();
		},
		toRecipients: (n) => {
			message.toRecipients = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		uniqueBody: (n) => {
			message.uniqueBody = n.getObjectValue<ItemBody>(createItemBodyFromDiscriminatorValue);
		},
		webLink: (n) => {
			message.webLink = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoMessageCollectionResponse(messageCollectionResponse: Partial<MessageCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			messageCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			messageCollectionResponse.value = n.getCollectionOfObjectValues<Message>(createMessageFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoMessageRule(messageRule: Partial<MessageRule> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		actions: (n) => {
			messageRule.actions = n.getObjectValue<MessageRuleActions>(createMessageRuleActionsFromDiscriminatorValue);
		},
		conditions: (n) => {
			messageRule.conditions = n.getObjectValue<MessageRulePredicates>(createMessageRulePredicatesFromDiscriminatorValue);
		},
		displayName: (n) => {
			messageRule.displayName = n.getStringValue();
		},
		exceptions: (n) => {
			messageRule.exceptions = n.getObjectValue<MessageRulePredicates>(createMessageRulePredicatesFromDiscriminatorValue);
		},
		hasError: (n) => {
			messageRule.hasError = n.getBooleanValue();
		},
		isEnabled: (n) => {
			messageRule.isEnabled = n.getBooleanValue();
		},
		isReadOnly: (n) => {
			messageRule.isReadOnly = n.getBooleanValue();
		},
		sequence: (n) => {
			messageRule.sequence = n.getNumberValue();
		},
	};
}
/**
...
export function deserializeIntoMessageRuleActions(messageRuleActions: Partial<MessageRuleActions> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		assignCategories: (n) => {
			messageRuleActions.assignCategories = n.getCollectionOfPrimitiveValues<string>();
		},
		copyToFolder: (n) => {
			messageRuleActions.copyToFolder = n.getStringValue();
		},
		delete: (n) => {
			messageRuleActions.delete = n.getBooleanValue();
		},
		forwardAsAttachmentTo: (n) => {
			messageRuleActions.forwardAsAttachmentTo = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		forwardTo: (n) => {
			messageRuleActions.forwardTo = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		markAsRead: (n) => {
			messageRuleActions.markAsRead = n.getBooleanValue();
		},
		markImportance: (n) => {
			messageRuleActions.markImportance = n.getEnumValue<Importance>(ImportanceObject);
		},
		moveToFolder: (n) => {
			messageRuleActions.moveToFolder = n.getStringValue();
		},
		permanentDelete: (n) => {
			messageRuleActions.permanentDelete = n.getBooleanValue();
		},
		redirectTo: (n) => {
			messageRuleActions.redirectTo = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		stopProcessingRules: (n) => {
			messageRuleActions.stopProcessingRules = n.getBooleanValue();
		},
	};
}
/**
...
export function deserializeIntoMessageRuleCollectionResponse(messageRuleCollectionResponse: Partial<MessageRuleCollectionResponse> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		"@odata.nextLink": (n) => {
			messageRuleCollectionResponse.odataNextLink = n.getStringValue();
		},
		value: (n) => {
			messageRuleCollectionResponse.value = n.getCollectionOfObjectValues<MessageRule>(createMessageRuleFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoMessageRulePredicates(messageRulePredicates: Partial<MessageRulePredicates> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		bodyContains: (n) => {
			messageRulePredicates.bodyContains = n.getCollectionOfPrimitiveValues<string>();
		},
		bodyOrSubjectContains: (n) => {
			messageRulePredicates.bodyOrSubjectContains = n.getCollectionOfPrimitiveValues<string>();
		},
		categories: (n) => {
			messageRulePredicates.categories = n.getCollectionOfPrimitiveValues<string>();
		},
		fromAddresses: (n) => {
			messageRulePredicates.fromAddresses = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		hasAttachments: (n) => {
			messageRulePredicates.hasAttachments = n.getBooleanValue();
		},
		headerContains: (n) => {
			messageRulePredicates.headerContains = n.getCollectionOfPrimitiveValues<string>();
		},
		importance: (n) => {
			messageRulePredicates.importance = n.getEnumValue<Importance>(ImportanceObject);
		},
		isApprovalRequest: (n) => {
			messageRulePredicates.isApprovalRequest = n.getBooleanValue();
		},
		isAutomaticForward: (n) => {
			messageRulePredicates.isAutomaticForward = n.getBooleanValue();
		},
		isAutomaticReply: (n) => {
			messageRulePredicates.isAutomaticReply = n.getBooleanValue();
		},
		isEncrypted: (n) => {
			messageRulePredicates.isEncrypted = n.getBooleanValue();
		},
		isMeetingRequest: (n) => {
			messageRulePredicates.isMeetingRequest = n.getBooleanValue();
		},
		isMeetingResponse: (n) => {
			messageRulePredicates.isMeetingResponse = n.getBooleanValue();
		},
		isNonDeliveryReport: (n) => {
			messageRulePredicates.isNonDeliveryReport = n.getBooleanValue();
		},
		isPermissionControlled: (n) => {
			messageRulePredicates.isPermissionControlled = n.getBooleanValue();
		},
		isReadReceipt: (n) => {
			messageRulePredicates.isReadReceipt = n.getBooleanValue();
		},
		isSigned: (n) => {
			messageRulePredicates.isSigned = n.getBooleanValue();
		},
		isVoicemail: (n) => {
			messageRulePredicates.isVoicemail = n.getBooleanValue();
		},
		messageActionFlag: (n) => {
			messageRulePredicates.messageActionFlag = n.getEnumValue<MessageActionFlag>(MessageActionFlagObject);
		},
		notSentToMe: (n) => {
			messageRulePredicates.notSentToMe = n.getBooleanValue();
		},
		recipientContains: (n) => {
			messageRulePredicates.recipientContains = n.getCollectionOfPrimitiveValues<string>();
		},
		senderContains: (n) => {
			messageRulePredicates.senderContains = n.getCollectionOfPrimitiveValues<string>();
		},
		sensitivity: (n) => {
			messageRulePredicates.sensitivity = n.getEnumValue<Sensitivity>(SensitivityObject);
		},
		sentCcMe: (n) => {
			messageRulePredicates.sentCcMe = n.getBooleanValue();
		},
		sentOnlyToMe: (n) => {
			messageRulePredicates.sentOnlyToMe = n.getBooleanValue();
		},
		sentToAddresses: (n) => {
			messageRulePredicates.sentToAddresses = n.getCollectionOfObjectValues<Recipient>(createRecipientFromDiscriminatorValue);
		},
		sentToMe: (n) => {
			messageRulePredicates.sentToMe = n.getBooleanValue();
		},
		sentToOrCcMe: (n) => {
			messageRulePredicates.sentToOrCcMe = n.getBooleanValue();
		},
		subjectContains: (n) => {
			messageRulePredicates.subjectContains = n.getCollectionOfPrimitiveValues<string>();
		},
		withinSizeRange: (n) => {
			messageRulePredicates.withinSizeRange = n.getObjectValue<SizeRange>(createSizeRangeFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoMultiValueLegacyExtendedProperty(multiValueLegacyExtendedProperty: Partial<MultiValueLegacyExtendedProperty> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		value: (n) => {
			multiValueLegacyExtendedProperty.value = n.getCollectionOfPrimitiveValues<string>();
		},
	};
}
/**
...
export function deserializeIntoOutlookItem(outlookItem: Partial<OutlookItem> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		categories: (n) => {
			outlookItem.categories = n.getCollectionOfPrimitiveValues<string>();
		},
		changeKey: (n) => {
			outlookItem.changeKey = n.getStringValue();
		},
		createdDateTime: (n) => {
			outlookItem.createdDateTime = n.getDateValue();
		},
		lastModifiedDateTime: (n) => {
			outlookItem.lastModifiedDateTime = n.getDateValue();
		},
	};
}
/**
...
export function deserializeIntoRecipient(recipient: Partial<Recipient> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		emailAddress: (n) => {
			recipient.emailAddress = n.getObjectValue<EmailAddress>(createEmailAddressFromDiscriminatorValue);
		},
	};
}
/**
...
export function deserializeIntoSingleValueLegacyExtendedProperty(singleValueLegacyExtendedProperty: Partial<SingleValueLegacyExtendedProperty> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		...
		value: (n) => {
			singleValueLegacyExtendedProperty.value = n.getStringValue();
		},
	};
}
/**
...
export function deserializeIntoSizeRange(sizeRange: Partial<SizeRange> | undefined = {}): Record<string, (node: ParseNode) => void> {
	return {
		maximumSize: (n) => {
			sizeRange.maximumSize = n.getNumberValue();
		},
		minimumSize: (n) => {
			sizeRange.minimumSize = n.getNumberValue();
		},
	};
}
