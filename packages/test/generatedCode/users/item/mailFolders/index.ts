 ...
 */
export class MailFoldersRequestBuilder extends BaseRequestBuilder<MailFoldersRequestBuilder> {
    /**
     * The Count property
     */
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders{?includeHiddenFolders,%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", (x, y) => new MailFoldersRequestBuilder(x, y));
    }
    /**
