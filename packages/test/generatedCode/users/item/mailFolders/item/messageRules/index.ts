...
export class MessageRulesRequestBuilder extends BaseRequestBuilder<MessageRulesRequestBuilder> {
    ...
    public constructor(pathParameters: Record<string, unknown> | string | undefined, requestAdapter: RequestAdapter) {
        super(pathParameters, requestAdapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messageRules{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}", (x, y) => new MessageRulesRequestBuilder(x, y));
    }
    /**
